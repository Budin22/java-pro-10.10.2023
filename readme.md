...
Взяти домашку по JDBC (lesson-homework)
Створити  сервіс клас, який матиме наступний API:
отримання уроку за id з його домашкою
отримання всіх уроків
Створити сервлетний додаток з використанням динамічний сторінок JSP, який представлятиме графічно та дозволятиме:
Відобразити список всіх уроків на окремій сторінці
При кліку на певний урок відбувається перехід на сторінку цього уроку
На сторінці конкретного уроку також відображається домашка, асоційована з ним
Зʼєднати сервлетну частину з API рівня сервісів
